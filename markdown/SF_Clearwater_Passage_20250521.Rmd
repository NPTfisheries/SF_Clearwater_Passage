...
This report presents a preliminary assessment of adult steelhead passage at a suspected velocity barrier on the South Fork Clearwater River using detections of PIT-tagged fish. Key detection sites include SC3 (downstream of the barrier) and SC4 (upstream). The analysis includes adults PIT-tagged at Lower Granite Dam and those tagged at various locations, including within the South Fork Clearwater River. 

We focus on whether PIT-tagged adults detected at SC3 later appear at SC4, indicating successful upstream passage — or a lack thereof — across the high-velocity reach. We also examine how factors such as juvenile release location and river discharge relate to these "conversion" rates. Although the primary focus is steelhead, adult spring/summer Chinook salmon PIT detections are included for comparison.
...
lm_df = sf_df %>%
  ...
  # focus on unknown and upstream releast locations %>%
