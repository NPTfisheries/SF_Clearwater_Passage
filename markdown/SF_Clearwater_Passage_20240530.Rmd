...
```{r barrier-pic, out.width = "100%", fig.cap = "Computed water surface elevation (top) and velocity (bottom) with varying roughness (Manning's n) coefficients, presumably at 1,150 cfs at the barrier reach (unknown). Figure taken from Timm et al. (2017)."}
