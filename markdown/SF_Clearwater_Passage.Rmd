...
Based on PIT-tagged adult returns in spawn years 2022 and 2023, it is difficult to discern whether the high-velocity reach hinders or prevents upstream passage for steelhead. Estimated conversion rates to SC4 from SC3 were 13.9% and 15.6% for adult in spawn years 2022 and 2023, respectively; however, those rates are not considerably different that conversion rates of 29.3% and 13.4% to SC3 from SC2 (Table \@ref(tab:conv-rates)). Moreover, there were no discernable patterns to indicate that larger or older steelhead can pass the reach at higher rates than smaller fish, which would indicate that the reach is problematic for fish with weaker swimming capabilities. Very few adult steelhead were observed migrating to SC4 during water levels greater than 0.8m at SC4 (Table \@ref(tab:SC4-water-level)) or at flows greater than ~2,000 cfs (Table \@ref(tab:cfs)), but sample sizes are low. Finally, very few adults from juvenile releases upstream of the high-velocity reach were available for the evaluation; using observation data from adult returns originating from juvenile releases downstream of the reach is problematic because we are unsure about their propensity to migrate through the reach.
...
juv_rel_df %>%
  ...
  kable(booktabs = T,
        align = "ccc",
        caption = "Number of PIT-tagged juveniles released within Newsome Creek releases by year.") %>%
  kable_styling(full_width = F,
                position = "center",
                bootstrap_options = c("striped", "condensed"))
