...
We summarized conversion rates by water level (m) recorded at SC4 using the IPTDS environmental probe (Table \@ref(tab:SC4-water-level)). It is worth noting that above a water level of 0.8 m, only 1 of 23 steelhead that passed SC3 arrived at SC4; however, sample sizes are small and nearly all Chinook salmon that passed SC3 arrived at SC4 at similar water levels. For this summary, the water level recorded for each fish was the water level at SC4 when that fish was most recently seen at SC3, SC2, or SC1.
...
We also summarized the water level (m) at the time that each adult were most recently observed for those adults that arrived at SC4 (TRUE) versus those observed at SC3 that did not arrive at SC4 (FALSE). 
...
Similar to above, we summarized conversion rates by discharge (cfs) at USGS gage 13338500 near Stites, ID (Table \@ref(tab:cfs)). Here, only 4 of 43 adult steelhead that passed SC3 arrived at SC4 at flows greater than 1500 csf; but again, sample sizes are low and conversion rates for Chinook salmon at similar flows are high. 
...
We also considered release groups when evaluating conversion or passage rates through the high-velocity section; adults that return from juvenile releases downstream of the reach may not have the propensity to migrate through the reach. Table \@ref(tab:release groups) shows that among adult Chinook salmon and steelhead returning to the South Fork Clearwater River in spawn years 2022 and 2023, only 22 steelhead were from a juvenile release upstream near Newsome Creek (NEWSOC). Of those 22 steelhead, 3 were observed migrating through the high-velocity reach and arrived at SC4 (Table \@ref(tab:success-by-rg)). 
